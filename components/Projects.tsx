        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[1, 2, 3, 4].map((index) => (
              <div
                key={index}
                className="bg-surface p-8 rounded-lg border border-border flex flex-col h-full animate-pulse"
              >
                {/* Header skeleton */}
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((project) => (
            <div
              key={project.id}
              className="group relative bg-surface p-8 rounded-lg border border-border hover:border-primary/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-lg flex flex-col h-full"
            >
              <div className="flex justify-between items-center mb-8">
