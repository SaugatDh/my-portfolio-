    ...
    <section id="blog" className="py-24 bg-background relative z-10">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="grid gap-6 max-w-3xl">
          {posts.map((post) => (
            <div
              ...
              className="group flex flex-col md:flex-row md:items-baseline md:justify-between p-6 -mx-6 rounded-lg hover:bg-surface transition-colors cursor-pointer border border-transparent hover:border-border"
            >
        ...
        <div className="mt-12">
          <a
            href="/blog"
            className="inline-flex items-center text-sm font-mono font-bold text-foreground hover:text-primary transition-colors"
          >
            View all articles{" "}
            <svg
